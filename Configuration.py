...
start_date= datetime(year=2019,month=7,day=18,hour=19,minute=0)
pixelfulldict = {'1':((490,584),(84,200)),'2':((510,638),(256,378)),'3':((395,499),(46,198)),'4':((375,493),(246,384)),
...
def parse_args(is_training=True):
    if is_training:
        ...
        parser.add_argument('--num_levels',type=int,default=5,help='Number of TCN levels')
        parser.add_argument('--num_hidden',type=int,default=1000,help='Number of TCN hidden feature maps')
        parser.add_argument('--embedding_size2',type=int,default=80,help='TCN Output layer dimension')
        parser.add_argument('--embedding_size1',type=int,default=2048,help='TCN Output layer dimension')
        parser.add_argument('--kernel_size',type=int,default=5,help='TCN feature map size (nxn)')
